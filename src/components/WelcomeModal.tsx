      ...
      <DialogContent className="max-w-md z-[60]" showCloseButton={false}>
        <DialogHeader>
          <div className="flex items-center gap-2 mb-2">
            ...
            <DialogTitle className="text-lg">K-Place에 오신 것을 환영합니다!</DialogTitle>
          </div>
        </DialogHeader>

        <div className="text-left text-sm text-gray-600 leading-relaxed space-y-3">
          <p>
            안녕하세요! K-Place를 방문해 주셔서 감사합니다.
          </p>
          <p>
            현재 K-Place는 <strong>초기 버전</strong>으로 운영 중이며,
            아직 불안정한 부분이 많을 수 있습니다.
          </p>
          <p>
            사용 중 불편한 점이나 개선이 필요한 부분이 있으시면
            언제든 피드백을 남겨주시면 큰 도움이 됩니다.
          </p>
          <p className="text-gray-700 font-medium">
            더 나은 서비스를 만들기 위해 최선을 다하겠습니다.<br />
            감사합니다.
          </p>
        </div>
