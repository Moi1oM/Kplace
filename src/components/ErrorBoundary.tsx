  ...
  if (error instanceof TRPCClientError<AppRouter>) {
    switch (error.data?.code) {
      ...
      case 'TOO_MANY_REQUESTS':
        ...
        showNotification(`쿨다운 중입니다. ${remainingSeconds}초 후 다시 시도해주세요.`, 'warning');
        break;
...
// 알림 표시 함수
function showNotification(message: string, type: 'info' | 'warning' | 'error' | 'success' = 'info') {
  // 기존 알림 제거
  ...
  notification.className = 'fixed top-4 left-1/2 transform -translate-x-1/2 z-[100] animate-in fade-in slide-in-from-top-2 duration-300';
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
          <Alert className="max-w-md">
            ...
            <AlertDescription>
              ...
              <p className="mt-2">페이지를 새로고침하거나 잠시 후 다시 시도해주세요.</p>
              <button
